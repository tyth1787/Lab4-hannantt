...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2010,10,5),new DateTime(2010, 10, 10), 200);
            var remainingFlight = new Flight(new DateTime(2010, 5, 2), new DateTime(2010, 5, 12), 400);
